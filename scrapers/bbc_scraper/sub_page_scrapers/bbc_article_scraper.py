...
def scrape_article(path, uReq, soup, keyword_list):
    ...
    content_tag_array = sub_page_soup.findAll("div", {"class" : "1-container"}) #find tags in the soup object
    ...
    if(len(content_tag_array) > 0):
        ...
        if(relevant_story): #execute if a story contains a keyword
            ...
            title_tag_array = sub_page_soup.findAll("h1", {"class" : "-----"}) #find tags in the soup object for beef object title //TODO

            date_tag_array = sub_page_soup.findAll("p", {"class" : "-----"})#find tags in the soup object for beef object date //TODO

            date_string = date_tag_array[0].text #format date //TODO
