...
#scraper imports
from scrapers.bossip_scraper.sub_page_scrapers.bossip_article_scraper import scrape_article # import article scraper
...
def scrape_bossip_home(uReq, soup, keyword_list):
    ...
    if raw_page_html is not None:
        ...
        news_tag_array = page_soup.findAll("article", {"class", "home-track"})#, text=pattern) #find tags in the soup object
