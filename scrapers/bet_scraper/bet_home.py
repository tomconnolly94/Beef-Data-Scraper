...
#scraper imports
from scrapers.bet_scraper.sub_page_scrapers.bet_article_scraper import scrape_article # import article scraper

def scrape_bet_home(uReq, soup, keyword_list):
    
    logging = None
    
    base_url = 'http://www.bet.com/' #url to scrape
